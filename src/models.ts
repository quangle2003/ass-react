...
export const addProductSchema = Yup.object({
    ten: Yup.string().required("trường dữ liệu bắt buộc"),
    gia: Yup.number().required("trường dữ liệu bắt buộc"),
    mota: Yup.string().required("trường dữ liệu bắt buộc"),
    thuonghieu: Yup.string().required("trường dữ liệu bắt buộc")
})
export type addForm = Yup.InferType<typeof addProductSchema>
